...
import entities.CorteServicioMedia;
import entities.RepoService;
import entities.SinLuzRepositorio;
...
@SpringBootApplication(scanBasePackages={"enre","entities"})
@EnableJpaRepositories(basePackages="entities", repositoryFactoryBeanClass = SinLuzRepositorio.class)
public class Scraping_enre implements CommandLineRunner{
    ...
    public static final int cantidadLecturas = 10;
    ...
    /*@Bean
	public void demo(SinLuzRepositorio repository) {
	...
	public void run(String... arg0) throws Exception {
    	...
    	System.out.println("Comprobando entradas de: "+repo.getClass());	
	}
    
    public void proceso (String args[]) {
        ...
        for (int i=1; i<cantidadLecturas; i++){
			...
			try {
	            ...
	            Thread.sleep(10000*60*15);//10 seg
